					...
					<c:when test="${not empty requestScope.foodTypes}">
						<c:forEach items="${requestScope.foodTypes}" var="foodType">
							<tr>
								...
								<td>
									<a href="/foodType?method=viewUpdate&typeId=${foodType.id}" class="FunctionButton">更新</a>
									<a href="/foodType?method=delete&typeId=${foodType.id}" class="FunctionButton">删除</a>
								</td>
							</tr>
						</c:forEach>
					</c:when>
