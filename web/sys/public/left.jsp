	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="/dinnerTable?method=findAll">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="/foodType?method=typelist">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="/food?method=listFood">菜品管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="/order?method=toOrderList">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
